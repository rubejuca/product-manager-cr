...
class ProductManagerTest {
    ...
    void testGetProductsByPriceRange() {
        ...
        ProductManager manager = new ProductManager();
        Product p1 = new Product("1", "Laptop", "Electronics", 1200.0);
        Product p2 = new Product("2", "Shirt", "Clothing", 1100.0);
        Product p3 = new Product("3", "Book", "Education", 25.0);
        ...
        List<Product> electronics = manager.getProductsByPriceRange(1000.0, 2000.0);

        assertEquals(2, electronics.size());
        assertEquals("Laptop", electronics.get(0).getName());
        assertTrue(electronics.contains(p1));
        assertFalse(electronics.contains(p3));
    }

    @Test
    void testGetProductByPriceMin() {
        ...
        assertEquals(0, electronics.size());

    }

    @Test
    void testGetProductByPriceMax() {

        ProductManager manager = new ProductManager();
        Product p3 = new Product("3", "Book", "Education", 3000.0);
